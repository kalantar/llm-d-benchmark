...
export LLMDBENCH_VLLM_STANDALONE_ENABLE_SLEEP_MODE=${LLMDBENCH_VLLM_STANDALONE_ENABLE_SLEEP_MODE:-false}
...
# add sleep mode argument if requested
enable_sleep_mode_arg="--enable-sleep-mode"
shopt -s nocasematch # Enable case-insensitive matching
if [[ "$LLMDBENCH_VLLM_STANDALONE_ENABLE_SLEEP_MODE" == "true"  && "$LLMDBENCH_VLLM_STANDALONE_ARGS" != *"$enable_sleep_mode_arg"* ]]; then
  export LLMDBENCH_VLLM_STANDALONE_ARGS=${LLMDBENCH_VLLM_STANDALONE_ARGS}____${enable_sleep_mode_arg}
fi
